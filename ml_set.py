...
def kmer_load_all_A():
    x_train_embedding = torch.tensor(np.load('./dataset/all/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/A/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_all_C():
    x_train_embedding = torch.tensor(np.load('./dataset/all/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/C/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_all_G():
    x_train_embedding = torch.tensor(np.load('./dataset/all/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/G/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_all_U():
    x_train_embedding = torch.tensor(np.load('./dataset/all/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/U/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_A():
    x_train_embedding = torch.tensor(np.load('./dataset/A/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/A/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_C():
    x_train_embedding = torch.tensor(np.load('./dataset/C/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/C/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_G():
    x_train_embedding = torch.tensor(np.load('./dataset/G/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/G/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
...
def kmer_load_U():
    x_train_embedding = torch.tensor(np.load('./dataset/U/KN_features_train.npy')).to('cuda')
    x_test_embedding = torch.tensor(np.load('./dataset/U/KN_features_test.npy')).to('cuda')
    return x_train_embedding, x_test_embedding
